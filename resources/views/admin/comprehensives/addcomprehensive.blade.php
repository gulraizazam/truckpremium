    ...
    <section id="">
      ...
      <section class="panel">
        ...
        <div class="panel-body">
          <div class="form">
            <form class="form-validate form-horizontal" id="feedback_form" method="post" action="{{ route('submitComprehensive')}}">
              @csrf
              ...
              <div class="form-group ">
                ...
                <div class="col-lg-10">
                  <input class="form-control" id="City" name="Comprehensiveprice"  type="number" required />
                </div>
              </div>
              <div class="form-group ">
